...
def apply_custom_theme():
    st.markdown("""
        ...
        .stButton > button:hover { background-color: #3f0a29; transition: 0.3s ease-in-out; }
    ...
    st.markdown("""
        <div style='text-align: center;'>
            ...
            <p style='font-size: 14px; color: #fce4ec;'>
                Di sini kamu bisa cek seberapa sehat gaya hidupmu dan prediksi tingkat obesitas berdasarkan kebiasaan harian.<br><br>
...
if st.session_state.menu == "prediksi":
    ...
    with st.form("form_prediksi"):
        st.subheader("Masukkan Data Gaya Hidup Anda")
